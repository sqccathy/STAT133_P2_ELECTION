...
countydata <- data.frame(fips = final$combined_fips, county_name = final$County, state = final$State, voteMargin = (final$ClintonVote2016 - final$TrumpVote2016) /(final$ClintonVote2016 + final$TrumpVote2016), stringsAsFactors = F)
...
ggplot(choropleth, aes(long, lat, group = group)) +
    geom_polygon(aes(fill = voteMargin)) + scale_fill_brewer(palette = "RdBu") + ggtitle("2016 Percentage Vote Margin by County")
```
