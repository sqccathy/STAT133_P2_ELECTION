...
## Census data from the 2010 census (BY JOHN TOWEY)
  ...
  Then we extract employment data, including labor force participation and unemployent rates, female labor force partiipation and employent rates--which we use to derive female unemployment rates--and employment by occupation and industry.
```{r eval = createCensus}
  # POPULATION DATA
