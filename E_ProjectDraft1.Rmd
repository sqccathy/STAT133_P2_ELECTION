...
countyVotes2008 = data.frame(County, obamaVote2008 = Obama, McCainVote2008 = McCain)
...
cNames = paste(data2016$state_abbr, cNames, sep = "")
...
data2016 = data2016[-(seq(1, 29, by=1)), ]
```
