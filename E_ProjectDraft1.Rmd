...
The statistical summaries of these population data before and after the merge indicate that 3 counties have measures for total population, but not white population. We must keep this in mind for those analyses using the two variables for the white population.
