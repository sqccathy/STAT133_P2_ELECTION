...
```
  ...
  We want to find the reasons for these changes and we assume that it is related to percent of white and percent of single mothers. Thus we make a scatter plot and color the points by classifications to see if there are some connections.
```{r echo = codeInclude}
